        ...
        <div className="max-w-3xl">
            ...
            <section id="quick-start" className="mb-12 scroll-mt-16">
                ...
                <p className="text-base text-zinc-600 dark:text-zinc-400 mb-6">
                    The fastest way to install Antigravity Kit is using{" "}
                ...
                <Callout type="info">
                    <strong>Note:</strong> This command will create a{" "}
                    <code>.agent</code> folder in your current directory
                    containing all templates.
                </Callout>
            </section>
            ...
            <section id="global-install" className="mb-12 scroll-mt-16">
                ...
                <p className="text-base text-zinc-600 dark:text-zinc-400 mb-6">
                    Install the CLI globally to use{" "}
                    <code className="px-1.5 py-0.5 rounded bg-zinc-100 dark:bg-zinc-800 text-sm font-mono">
                        ag-kit
                    </code>{" "}
                    command anywhere:
            ...
            <section id="structure" className="mb-12 scroll-mt-16">
                ...
                <p className="text-base text-zinc-600 dark:text-zinc-400 mb-6">
                    After running the installation command, you&apos;l have the
                    following structure:
                </p>
...
└── ARCHITECTURE.md  # Full documentation`}
                ...
                <div className="space-y-4">
                    <div className="p-4 rounded-lg border border-zinc-200 dark:border-zinc-800">
                        ...
                        <p className="text-sm text-zinc-600 dark:text-zinc-400">
                            Contains 16 specialist AI agent configurations for
                            different domains (frontend, backend, security,
                            etc.)
                        </p>
                    </div>
                    <div className="p-4 rounded-lg border border-zinc-200 dark:border-zinc-800">
                        ...
                        <p className="text-sm text-zinc-600 dark:text-zinc-400">
                            40+ domain-specific knowledge modules that agents
                            can use
                        </p>
                    </div>
                    <div className="p-4 rounded-lg border border-zinc-200 dark:border-zinc-800">
                        ...
                        <p className="text-sm text-zinc-600 dark:text-zinc-400">
                            11 slash command procedures for common development
                            tasks
                        </p>
                    </div>
                    <div className="p-4 rounded-lg border border-zinc-200 dark:border-zinc-800">
            ...
            <section id="requirements" className="mb-12 scroll-mt-16">
                ...
                <ul className="space-y-2 text-base text-zinc-600 dark:text-zinc-400 mb-6">
                    <li className="flex items-start gap-2">
                        <svg
                            className="w-5 h-5 text-green-600 dark:text-green-500 mt-0.5 shrink-0"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                        >
            ...
            <section className="mb-12">
                ...
                <p className="text-base text-zinc-600 dark:text-zinc-400 mb-6">
                    Now that you have Antigravity Kit installed, learn about the
                    core concepts:
                </p>
