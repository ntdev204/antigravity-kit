        ...
        <div className="max-w-3xl">
            ...
            <div className="mb-8 pb-8 border-b border-zinc-200 dark:border-zinc-800">
                ...
                <p className="text-lg text-zinc-600 dark:text-zinc-400">
                    Command-line interface for managing Antigravity Kit
                    installations.
                </p>
            </div>
            ...
            <section className="mb-12">
                ...
                <p className="text-base text-zinc-600 dark:text-zinc-400 mb-6">
                    ...
                    CLI tool helps you manage Antigravity Kit installations
                ...
                <div className="space-y-8">
                    ...
                    <div>
                        ...
                        <p className="text-base text-zinc-600 dark:text-zinc-400 mb-4">
                            Initialize Antigravity Kit in your project by
                            installing the{" "}
                            <code className="px-1.5 py-0.5 rounded bg-zinc-100 dark:bg-zinc-800 text-sm font-mono">
                                .agent
                            </code>{" "}
                        ...
                        <div className="p-4 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/50">
                            ...
                            <ul className="text-sm text-zinc-600 dark:text-zinc-400 space-y-1">
                                <li>
                                    • Creates{" "}
                                    <code className="px-1 py-0.5 rounded bg-zinc-200 dark:bg-zinc-800 font-mono text-xs">
                                        .agent/
                                    </code>{" "}
                    ...
                    <div>
                        ...
                        <p className="text-base text-zinc-600 dark:text-zinc-400 mb-4">
                            Update your existing Antigravity Kit installation to
                            the latest version.
                        </p>
                        ...
                        <div className="p-4 rounded-lg border border-amber-200 dark:border-amber-900 bg-amber-50 dark:bg-amber-950/20">
                            <p className="text-sm text-amber-900 dark:text-amber-200">
                                ...
                                This will delete and replace your{" "}
                                <code className="px-1 py-0.5 rounded bg-amber-100 dark:bg-amber-900/40 font-mono text-xs">
                                    .agent/
                                </code>{" "}
                                folder. Make sure to backup any custom changes.
                            </p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-base text-zinc-600 dark:text-zinc-400 mb-4">
                            Check the current installation status and version
                            information.
                        </p>
                        ...
                        <div className="p-4 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/50">
                            ...
                            <ul className="text-sm text-zinc-600 dark:text-zinc-400 space-y-1">
                                <li>
                                    • Installation status (installed/not
                                    installed)
                                </li>
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-sm border border-zinc-200 dark:border-zinc-800">
                        <thead className="bg-zinc-50 dark:bg-zinc-900/50">
                            <tr>
                                <th className="text-left py-3 px-4 font-semibold text-zinc-900 dark:text-zinc-50 border-b border-zinc-200 dark:border-zinc-800">
                                    Option
                                </th>
                                <th className="text-left py-3 px-4 font-semibold text-zinc-900 dark:text-zinc-50 border-b border-zinc-200 dark:border-zinc-800">
                                    Description
                        ...
                        <tbody className="divide-y divide-zinc-200 dark:divide-zinc-800">
                            <tr>
                                <td className="py-3 px-4">
                                    <code className="font-mono text-zinc-900 dark:text-zinc-50">
                                        --force
                                    </code>
                                </td>
                            ...
                            <tr>
                                ...
                                <td className="py-3 px-4 text-zinc-600 dark:text-zinc-400">
                                    Install in specific directory instead of
                                    current folder
                                </td>
                            </tr>
                            <tr>
