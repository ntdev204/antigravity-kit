            ...
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription className="space-y-2 pt-2">
                        Hi! I'm <strong>Vu</strong>. I'm dedicating my full-time
                        work to building this kit. <br />
                        Your support helps me keep shipping and maintaining it.
                        If you find this tool helpful, please consider buying me
                        a coffee.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="space-y-3 p-4">
                    {/* Buy Me a Coffee */}
                    <a
                        href="https://buymeacoffee.com/ntdev204"
                        target="_blank"
                    ...
                    >
                        ...
                        <div className="flex-1">
                            ...
                            <div className="text-sm text-zinc-600 dark:text-zinc-400">
                                Direct transfer via QR code
                            </div>
                        </div>
                        <svg
                            className={`w-5 h-5 text-zinc-400 transition-transform ${showQR ? "rotate-90" : ""}`}
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                        >
                    ...
                    {/* Hire Me Option */}
                    {/* <a
                        href="https://www.linkedin.com/in/ntdev204" // Assuming this link based on username, user can update
                        target="_blank"
                        rel="noopener noreferrer"
