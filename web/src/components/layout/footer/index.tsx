            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            ...
                            <li>
                                <a
                                    href="https://github.com/ntdev204/antigravity-kit/releases"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-50 transition-colors"
                                >
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            ...
                            <li>
                                <a
                                    href="https://github.com/ntdev204/antigravity-kit/issues"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-50 transition-colors"
                                >
                            ...
                            <li>
                                <a
                                    href="https://github.com/ntdev204/antigravity-kit/discussions"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-50 transition-colors"
                                >
                            ...
                            <li>
                                <a
                                    href="https://github.com/ntdev204/antigravity-kit/blob/main/CONTRIBUTING.md"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-50 transition-colors"
                                >
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            <li>
                                <a
                                    href="https://github.com/ntdev204/antigravity-kit/blob/main/LICENSE"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-50 transition-colors"
                                >
                ...
                <div className="pt-8 border-t border-zinc-200 dark:border-zinc-800 flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <p className="text-sm text-zinc-600 dark:text-zinc-400">
                        ...
                        <a
                            href="https://github.com/ntdev204"
                            target="_blank"
                            rel="noopener noreferrer"
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <a
                            href="https://facebook.com/ntdev204.354"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-50 transition-colors"
                            aria-label="Facebook"
